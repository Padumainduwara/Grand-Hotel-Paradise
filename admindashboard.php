...
<body>
    ...
    <div class="container">
		<h1>Welcome, Admin</h1>
        <!-- Buttons -->
        <button onclick="location.href='adminaccountcreate.php'">Create Admin/Staff Accounts</button>
        ...
        <button onclick="location.href='edit_packages.php'"> Edit Packages </button>
    </div>
</body>
</html>
